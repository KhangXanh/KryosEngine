...
//#define IMGUI_DISABLE_DEFAULT_FORMAT_FUNCTIONS            // Don't implement ImFormaString/ImFormaStringV so you can implement them yourself (e.g. if you don't want to link with vsnprintf)
